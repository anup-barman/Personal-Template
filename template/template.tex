...
\newcommand{\maketeampage}{
    ...
    \begin{center}
        ...
        {\fontsize{20}{24}\selectfont\textbf{\universityName}}
        \vspace{3cm}
        
        {\fontsize{72}{80}\selectfont\bfseries\textcolor{CfCyan}{Anup Barman}}
        \vspace{3cm}
        
        {\fontsize{13}{15}\selectfont\textcolor{black!70}{Personal Reference Document}}
    \end{center}
